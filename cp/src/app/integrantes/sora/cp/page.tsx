    ...
    return (
        <div className="container_trabalhos">
                    ...
                    <div>
                        ...
                        <div className="texto_icones_caixa">
                            ...
                            <div className="icones_caixa">
                                <Link href={`/integrantes/sora/cp/cp/${trabalho.id}`} className="botoes_trabalhos"><Image src={iconeEditar} alt="Icone de Editar" className="icones"/></Link>
            ...
            <div className="caixa_adicionar">
                <Link href="/integrantes/sora/cp/cad-cp" className="links_adiconar"><Image src={iconeAdicionar} alt="Icone de Adicionar" className="icone_adicionar"/></Link>
            </div>
        </div>
    );
}
